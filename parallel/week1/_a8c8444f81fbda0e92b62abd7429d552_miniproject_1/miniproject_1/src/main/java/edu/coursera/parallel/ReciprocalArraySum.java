...
public final class ReciprocalArraySum {
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks; i++) {
        	int nStart = getChunkStartInclusive(i, numTasks, length);
        	int nEnd = getChunkEndExclusive(i, numTasks, length);
        	ReciprocalArraySumTask task = new ReciprocalArraySumTask(nStart, nEnd, input);
        	tasks.add(task);
        }
